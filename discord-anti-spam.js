...
class AntiSpamClient extends EventEmitter {
	...
	constructor (options) {
		...
		this.options = {
			...
			warnThreshold: parseInt(options.warnThreshold) || 3,
			muteThreshold: parseInt(options.muteThreshold) || 4,
			kickThreshold: parseInt(options.kickThreshold) || 5,
			banThreshold: parseInt(options.banThreshold) || 7,

			maxInterval: parseInt(options.maxInterval) || 2000,
			maxDuplicatesInterval: parseInt(options.maxDuplicatesInterval) || 2000,

			maxDuplicatesWarn: parseInt(options.maxDuplicatesWarn) || 7,
			maxDuplicatesMute: parseInt(options.maxDuplicatesMute) || 9,
			maxDuplicatesKick: parseInt(options.maxDuplicatesKick) || 10,
			maxDuplicatesBan: parseInt(options.maxDuplicatesBan) || 11,

			unMuteTime: parseInt(options.unMuteTime) * 60_000 || 300000,
			...
			removeBotMessagesAfter: parseInt(options.removeBotMessagesAfter) || 2000,
	...
	// Returns the current value for the provided attribute
